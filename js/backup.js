...
async function clearAllData() {
  if (!confirm('⚠️ 농장·약품·백신·사료첨가제·프로그램·입추·투약이력·처방전·계군 임상평가·구서 평가·출하전검사·이동승인서·산란성계 출하대장이 모두 삭제됩니다.\n(처방 제품 마스터는 유지됩니다)\n반드시 백업 후 진행하세요.\n\n정말로 삭제하시겠습니까?')) return;
  ...
  try {
    ...
    for (const table of ['medication_logs','clinical_assessments','rodent_assessments','pre_shipment_inspections','move_permits','hen_shipments','prescriptions','batches','programs','feeds','vaccines','drugs','farms']) {
