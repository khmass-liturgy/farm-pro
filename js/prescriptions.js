...
function printPrescription(id) {
  ...
  const cells = [
    ...
    rxCell('label', 2, 5, 5, 7, '동물의 이름'),
    rxCell('value', 5, 8, 5, 7, ''),
    ...
    rxCell('label', 2, 5, 7, 8, '동물의 종류'),
    rxCell('value', 5, 8, 7, 8, ''),
    rxCell('label', 13, 14, 7, 8, '생년월일'),
    rxCell('value', 14, 16, 7, 8, rx.ownerBirth || '-'),
    rxCell('label', 2, 5, 8, 9, '성별/연령/체중'),
    rxCell('value', 5, 8, 8, 9, '암·수 / 세 / kg / 임신'),
